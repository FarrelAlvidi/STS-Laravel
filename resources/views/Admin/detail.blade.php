                    ...
                    <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                        ...
                        <tbody>
                            <tr class="border-b dark:border-gray-700">
                                ...
                                <td class="px-4 py-3">{{ $post['namaLengkap']}}</td>
                                <td class="px-4 py-3">{{ $post['asalSekolah']}}</td>
                                <td class="px-4 py-3">{{$post['created_at']}}</td>
                                <td class="px-4 py-3"><a href="{{route('admin.show', $post->id)}}" class="bg-orange-700 p-1 rounded-lg text-white">Show</a></td>
