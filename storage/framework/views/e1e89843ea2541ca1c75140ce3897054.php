...
<?php $component->withAttributes([]); ?>
    ...
    <section class="bg-white dark:bg-gray-900">
        <div class="py-8 px-4 mx-auto max-w-2xl lg:py-16">
            ...
            <form action="<?php echo e(route('admin2.store')); ?>" method="POST" enctype="multipart/form-data">
                <?php echo csrf_field(); ?>
...
<?php endif; ?><?php /**PATH C:\laragon\www\STS_Farrel_Alvidi\resources\views/admin/create.blade.php ENDPATH**/ ?>